...
from word_processor3 import get_audio_numpy
...
file_path = "easily_splittable_hiragana_data/あ3.m4a"
x, sampling_rate = get_audio_numpy(file_path)
# %%

plt.plot(x)
# %%
NFFT = int(48000 * 0.02)  # フレームの大きさ
